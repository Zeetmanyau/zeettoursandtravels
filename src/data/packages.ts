...
export const travelPackages: TravelPackage[] = [
  ...
  // DOMESTIC PACKAGES (11 packages)
  {
    ...
    description: 'Explore Majuli, the world’s largest river island nestled in the Brahmaputra River, known for its serene beauty and cultural richness.(Minimum 4 perople for a trip)',
    isActive: true,
  },
  {
    id: 'Andaman-tour',
  ...
  },
  {
    ...
    title: 'Dhekiakhowa Bor Namghar and Moinaporia Namghar Tour',
  ...
  },
  {
    ...
    title: 'Agninav Shiv Mandir and Sivsagar Tour',
  ...
  },
  {
    ...
    title: 'Athkhelia Namghar & Deopani Mandir Tour',
    location: 'Golaghat',
    duration: 'Single Day',
    price: 2000,
    rating: 4.6,
  ...
  },
  {
    ...
    title: 'Malinithan, Jagannath Temple & Bogibeel Bridge Tour',
  ...
  {
    id: 'Nagaon-temples',
    title: 'Mahamrityunjay Temple and Batadrava Than Tour',
  ...
  },
  {
    ...
    title: 'Golden Pagoda, Parshuram Kund & Dhola–Sadiya Bridge Tour',
  ...
  },
  {
    ...
    title: 'Sri Sri Basudev Than & Jagannath Temple Tour',
  ...
  // INTERNATIONAL PACKAGES (5 packages)
  {
    id: 'bhutan-cultural-odyssey',
    ...
    rating: 4.9,
    reviewCount: 87,
    imageUrl: '/images/packages/bhutan-cultural.jpg',
    highlights: ['Tigers Nest Monastery', 'Thimphu Dzong', 'Traditional Architecture', 'Gross National Happiness'],
    included: ['Visa Processing', 'Accommodation', 'All Meals', 'Guide', 'Transportation'],
    category: 'International',
    bestTime: 'March to May, September to November',
    description: 'Discover the Last Shangri-La with its pristine culture, stunning monasteries, and unique philosophy of Gross National Happiness.',
    isActive: false,
    detailedPdfUrl: 'https://drive.google.com/file/d/YOUR_BHUTAN_PDF_FILE_ID/view'
  },
  {
    id: 'nepal-himalayan-adventure',
    ...
    rating: 4.8,
    reviewCount: 156,
    imageUrl: '/images/packages/nepal-himalayan.jpg',
    highlights: ['Everest Base Camp Views', 'Pokhara Lake', 'Pashupatinath Temple', 'Mountain Flights'],
    included: ['Visa Processing', 'Accommodation', 'All Meals', 'Domestic Flights', 'Guide'],
    category: 'International',
    bestTime: 'September to November, March to May',
    description: 'Experience the majestic Himalayas with stunning mountain views, ancient temples, and rich cultural heritage.',
    isActive: false
  },
  {
    id: 'sri-lanka-island-paradise',
    ...
    rating: 4.7,
    reviewCount: 123,
    imageUrl: '/images/packages/sri-lanka-paradise.jpg',
    highlights: ['Sigiriya Rock Fortress', 'Tea Plantations', 'Buddhist Temples', 'Coastal Beauty'],
    included: ['Visa Processing', 'Accommodation', 'All Meals', 'Transportation', 'Guide'],
    category: 'International',
    bestTime: 'December to March, July to September',
    description: 'Explore the pearl of the Indian Ocean with ancient ruins, lush tea gardens, and pristine beaches.',
    isActive: false
  },
  {
    id: 'thailand-cultural-explorer',
    title: 'Thailand Cultural Explorer',
    ...
    rating: 4.8,
    reviewCount: 198,
    imageUrl: '/images/packages/thailand-cultural.jpg',
    highlights: ['Grand Palace', 'Floating Markets', 'Golden Triangle', 'Thai Cooking Classes'],
    included: ['Visa Processing', 'Accommodation', 'All Meals', 'Domestic Flights', 'Guide'],
    category: 'International',
    bestTime: 'November to March',
    description: 'Immerse yourself in Thai culture with magnificent temples, vibrant markets, and authentic culinary experiences.',
    isActive: false
  },
  {
    ...
    rating: 4.9,
    reviewCount: 145,
    imageUrl: '/images/packages/maldives-luxury.jpg',
    highlights: ['Overwater Villas', 'Coral Reefs', 'Water Sports', 'Sunset Cruises'],
    included: ['Visa Processing', 'Resort Accommodation', 'All Meals', 'Seaplane Transfers', 'Activities'],
    category: 'International',
    bestTime: 'November to April',
    description: 'Experience ultimate luxury in tropical paradise with crystal-clear waters, pristine beaches, and world-class resorts.',
    isActive: false
  },
